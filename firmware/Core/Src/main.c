...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, IO8_Pin|IO7_Pin|IO6_Pin|IO5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, IO10_Pin|IO9_Pin|IO4_Pin|IO3_Pin
                          |IO2_Pin|IO1_Pin|IO11_Pin|IO12_Pin
                          |IO13_Pin|IO14_Pin|IO15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IO8_Pin IO7_Pin IO6_Pin IO5_Pin */
  ...
  /*Configure GPIO pins : IO10_Pin IO9_Pin IO4_Pin IO3_Pin
                           IO2_Pin IO1_Pin IO11_Pin IO12_Pin
                           IO13_Pin IO14_Pin IO15_Pin */
  GPIO_InitStruct.Pin = IO10_Pin|IO9_Pin|IO4_Pin|IO3_Pin
                          |IO2_Pin|IO1_Pin|IO11_Pin|IO12_Pin
                          |IO13_Pin|IO14_Pin|IO15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
